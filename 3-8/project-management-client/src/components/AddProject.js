...
class AddProject extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        let res = await axios.post(`http://localhost:5000/api/projects`, this.state)
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <input onChange={this.handleChange} name="description" type="text" placeholder="Enter Description ..." />
